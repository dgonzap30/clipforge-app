/**
 * Effects Stage Tests
 * Combined tests for auto-zoom effects and transition effects
 */

import { describe, test, expect, mock, beforeEach, afterEach } from 'bun:test'
import { EffectsStage, effectsStage } from './effects'
...
describe('EffectsStage - Transition Effects', () => {
  let effectsStageInstance: EffectsStage

  beforeEach(() => {
    effectsStageInstance = new EffectsStage()
  })

  test('should have correct name', () => {
    expect(effectsStageInstance.name).toBe('effects')
  })
  ...
  test('should throw error if outputDir is missing', async () => {
    ...
    await expect(effectsStageInstance.execute(context)).rejects.toThrow(
  ...
  test('should validate context correctly', async () => {
    ...
    expect(await effectsStageInstance.validate(validContext)).toBe(true)
    expect(await effectsStageInstance.validate(invalidContext)).toBe(false)
  })
...
describe('effectsStage - Auto-Zoom Effects', () => {
  let testDir: string
