 ...
 *
 * Applies visual effects to reframed clips:
 ...
 *
 * Processes reframed clips and applies auto-zoom effects based on audio moments.
 * Zoom centers on face if face tracking data is available, otherwise centers on video.
 */
