        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex items-center gap-4">
              <div className="flex-1">
                ...
                <input type="number" defaultValue={15} className="input mt-1" />
              </div>
              <div className="flex-1">
                <label className="text-xs text-dark-400">Max (seconds)</label>
                <input type="number" defaultValue={60} className="input mt-1" />
              </div>
            </div>
          </div>
          ...
          <div>
            <label className="flex items-center gap-3 cursor-pointer">
              <input type="checkbox" defaultChecked className="w-5 h-5 rounded border-dark-600 bg-dark-800 text-forge-500 focus:ring-forge-500" />
              <div>
